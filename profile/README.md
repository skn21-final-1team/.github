...
### 깃허브 경로
- https://github.com/SKNETWORKS-FAMILY-AICAMP/SKN21_FINAL_1team
...
### 해결책
- 무료/오픈소스 모델(Llama 3, Mistral 등)을 활용  
- 누구나 **개인 서버 또는 로컬 환경에서 무료로 운영 가능한 RAG 서비스** 제공
...
- **타겟 사용자**
  - 연구자
  - 개발자
  - 대학생 등 방대한 웹 정보를 수집하지만 관리에 어려움을 느끼는 사용자
...
- **Open Source Strategy**
  - 핵심 엔진을 GitHub에 공개
  - 커뮤니티 기반 기능 개선 및 확장 유도

- **B2B 확장**
  - 기업 내부 위키 / 문서 링크 기반
  - 사내 지식 베이스 솔루션으로 커스터마이징 제공

- **Managed Service**
  - 인프라 관리가 어려운 사용자를 위한
  - 소액 구독형 호스팅 서비스(SaaS) 제공 가능
...
- **Frontend**
  - Next.js (사용자 인터페이스 및 북마크 업로드)
  - Chrome Extension

- **Backend**
  - FastAPI (Python 기반 고속 API 서버)

- **Crawler**
  - FireCrawl (URL 콘텐츠 추출)
  - DuckDuckGo (관련 내용 재검색)
...
- **LLM (추론)**
  - HuggingFace 무료 모델 (예정)

- **Embedding (벡터화)**
  - HuggingFace 무료 모델 (예정)

- **Framework**
  - LangGraph 또는 LlamaIndex 활용
  - RAG 파이프라인 구축
...
| DevOps | Docker 기반 배포 환경 구축, 서버 운영 관리 |
